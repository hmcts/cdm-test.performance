...
*/
    .exec(http("SSCS_030_015_CreateCase")
  ...
  val SSCSDocUpload = group("SSCS_DocUpload") {
    ...
    exec(http("SSCS_040_005_DocumentUploadPage")
    ...
    .exec(http("SSCS_040_010_DocumentUploadToDM")
  ...
  val SSCSSearchAndView = group("SSCS_View") {
    ...
    .exec(http("SSCS_050_025_OpenCase")
      .get("/data/internal/cases/${New_Case_Id}")
      .headers(headers_8))

    .pause(MinThinkTime seconds, MaxThinkTime seconds)

    .exec(http("SSCS_050_020_OpenDocument")
