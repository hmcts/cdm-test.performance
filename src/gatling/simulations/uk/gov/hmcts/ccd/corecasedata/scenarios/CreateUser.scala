...
object CreateUser {
  ...
  val feedUserData = csv("CaseSharingUsers_Large.csv")
  val feedDeleteData = csv("CaseSharingUserDataToDelete.csv")
  ...
  val IdamUser = feed(feedUserData)
    ...
    .exec(http("GetUserID")
      .get("https://idam-api.perftest.platform.hmcts.net/users?email=${userEmail}")
      .headers(headers_0)
    ...
    .doIf(session=>session("statusvalue").as[String].contains("200")) {
      exec {
        session =>
          ...
          try {
            fw.write(session("userEmail").as[String] + ","+session("userId").as[String] + "\r\n")
          }
          finally fw.close()
          session
      }
    ...
    .exec(http("001_caseworker-employment-api")
      .patch("https://idam-api.perftest.platform.hmcts.net/users/${userId}/roles/caseworker-employment-api")
      .headers(headers_0))

    .exec(http("002_caseworker-employment-leeds")
      .patch("https://idam-api.perftest.platform.hmcts.net/users/${userId}/roles/caseworker-employment-leeds")
      .headers(headers_0))

    .pause(1)

    .exec(http("000_DeleteDivorceSolicitor")
      .delete("https://idam-api.perftest.platform.hmcts.net/users/${userId}/roles/cb1ffd55-9dac-4b9e-8e69-94272238227c")
      .headers(headers_0))
    ...
    .exec(http("002_DeleteFRSolicitor")
      .delete("https://idam-api.perftest.platform.hmcts.net/users/${userId}/roles/cb323eda-ae36-42e3-8386-1abd27c7c9cf")
      .headers(headers_0))

    .exec(http("003_DeleteFRSolicitor")
      .delete("https://idam-api.perftest.platform.hmcts.net/users/${userId}/roles/0bc64378-49cf-4538-878c-44e48d619193")
      .headers(headers_0))

    .exec(http("004_DeleteFPLSolicitor")
      .delete("https://idam-api.perftest.platform.hmcts.net/users/${userId}/roles/23783d16-e51b-4109-a87e-adc5277f8f21")
      .headers(headers_0))

    .exec(http("005_AddCaseworkerProbateIssuer")
      .patch("https://idam-api.perftest.platform.hmcts.net/users/${userId}/roles/1a5a876b-222a-4b3f-9ddc-6cd77f9d98f3")
      .headers(headers_0))

    .exec(http("006_Payments")
      .patch("https://idam-api.perftest.platform.hmcts.net/users/${userId}/roles/bcdc8afa-c273-467c-b9b0-eb088b76f76a")
      .headers(headers_0))*/
