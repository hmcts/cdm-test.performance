...
object ExecuteLogin {
  ...
  val submitLogin = exec(http("CDM_020_005_Login")
		//.post(IDAM_URL + "/login?response_type=code&client_id=ccd_gateway&redirect_uri=https%3A%2F%2Fccd-case-management-web-aat.service.core-compute-aat.internal%2Foauth2redirect")
