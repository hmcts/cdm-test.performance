...
object Search {
  ...
  val searchRequest = exec(http("CDM_160_005_SearchRequest")
		.options("/data/caseworkers/:uid/jurisdictions/AUTOTEST1/case-types/AAT_PRIVATE/cases/pagination_metadata"))

		.exec(http("CDM_160_005_SearchRequest")
			.get("/data/caseworkers/:uid/jurisdictions/AUTOTEST1/case-types/AAT_PRIVATE/cases/pagination_metadata")
			.headers(CommonHeader))

		.pause(MinThinkTime seconds, MaxThinkTime seconds)
		
	val searchResult = exec(http("CDM_170_005_SearchResult")
		.options("/aggregated/caseworkers/:uid/jurisdictions/AUTOTEST1/case-types/AAT_PRIVATE/cases?view=WORKBASKET&page=1"))
		...
		.exec(http("CDM_170_015_SearchResult")
			.get("/aggregated/caseworkers/:uid/jurisdictions/AUTOTEST1/case-types/AAT_PRIVATE/cases?view=WORKBASKET&page=1")
			.headers(CommonHeader)
